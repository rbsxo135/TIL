...
- Two types of ACL -> Standard ACL/Extended ACL
...
- ACL tries to match target packet line-by-line, **top-from-bottom**
    -> If the packet matches the rule, that packet will be immediately permit or deny
...
-  List Access-List in Access-Group of interfaces
    -> Must choose inbound or outbound
&nbsp;
## Thought
