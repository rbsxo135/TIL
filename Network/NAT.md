...
- In NAT, many IP of network devices in the subnet translated in to a single Public IP
    &rightarrow; Put port number to distinguish various Public IPs
- Inside / Outside: Logical location of the device
    - Inside &rightarrow; The device in the subnet
    - Outside &rightarrow; The device out of the subnet
- Local / Global: From where IP is seen
    - Local &rightarrow; How Private space looks this IP
    - Global &rightarrow; How Public space looks this Ip
