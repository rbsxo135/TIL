...
## Condition
- HSRP has been set
    &rightarrow; CORE-RTR1(Router 2) is activated in peace time
- OSPF has been set
    &rightarrow; EDGE-RTR(Router 1) is area gateway router of area 0(Whole subnet) 

## Failover
- Core-RTR1 is down

    ![alt text](Packet_Tracer_Screenshots/Gateway_router_failover_after_failover.png)
    &rightarrow; As we can see, connection to the Internet quickly, automatically was recovered
- HSRP automatically activated CORE-RTR2(Router 3)

    ![alt text](Packet_Tracer_Screenshots/Gateway_router_failover_CORE-RTR2.png)
    &rightarrow; CORE-RTR2 worked as a backup gateway router
- OSPF automatically rerouted area 0

    ![alt text](Packet_Tracer_Screenshots/Gateway_router_failover_EDGE-RTR.png)

## Thoughts
- HSRP + OSPF &rightarrow; Come up with the backup router solution
- In failover situation, the network automatically recovers the situation
    &rightarrow; Advantage of the backup router solution